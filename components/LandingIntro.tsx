      ...
      <motion.div ref={grooviaRef} {...rise(step >= 5)} className="mt-10 w-full flex flex-col items-center">
        <div className="relative">
          ...
          <button
            ...
            className="relative rounded-full bg-gradient-to-r from-[#00377d] via-[#2a63b0] to-[#fe9d1c] px-6 py-2.5 sm:px-8 sm:py-3 text-base sm:text-lg font-bold text-white shadow-lg cursor-pointer hover:brightness-110 transition focus:outline-none focus:ring-2 focus:ring-white/60"
          >
