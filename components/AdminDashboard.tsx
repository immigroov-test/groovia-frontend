  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 py-10">
      ...
      <div className="mt-6">
        ...
        {tab === 'payouts' && (
          <Card>
            <CardBody className="pt-10 pb-10 flex flex-col items-center text-center gap-3">
              <p className="text-sm text-muted max-w-sm">
                Payouts, the ledger, and per-booking financial detail live on a dedicated page.
              </p>
              <Link
                href="/admin/financials"
                className="h-9 px-4 rounded-full text-sm font-medium bg-brand-900 text-white hover:bg-brand-800 inline-flex items-center"
              >
                Open Payouts &amp; ledger
              </Link>
            </CardBody>
