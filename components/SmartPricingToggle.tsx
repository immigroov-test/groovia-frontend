...
export function SmartPricingToggle({ initial }: { initial: boolean }) {
  ...
  return (
    <div className="rounded-[10px] border border-[--color-border] p-4 flex items-start justify-between gap-3">
      <div className="min-w-0">
        <div className="flex items-center gap-1.5">
          ...
          <span className="group relative inline-flex">
            ...
            <span className="pointer-events-none absolute left-1/2 -translate-x-1/2 bottom-full mb-2 w-64 rounded-lg bg-brand-900 text-white text-xs p-2 opacity-0 group-hover:opacity-100 transition-opacity z-20 shadow-[--shadow-2]">
