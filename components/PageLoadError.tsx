...
export function PageLoadError({
  ...
  message?: string;
  supportEmail?: string;
  /** HTTP status behind the failure. Shown small, so a screenshot of this page is diagnostic.
   *  Without it every failure looked identical and the real cause had to be guessed at. */
  status?: number;
}) {
  return (
