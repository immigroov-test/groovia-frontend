...
export const metadata = { title: 'How it works - Immigroov', description: 'From your first question to a focused conversation or live webinar.' };
export default function Page() { return <OrganizationPage eyebrow="HOW IT WORKS" title="A clearer path from question to action." intro="Immigroov helps you orient yourself, find relevant lived experience, and decide on a practical next step." sections={[
